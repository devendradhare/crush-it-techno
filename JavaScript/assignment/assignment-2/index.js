//fetch this data with the help of loop or forEach method
//fetch tha data in sequance image, name(firstname + lastname),university , gender, address (left the other thing)
//In each 4 card available mean each row have 4 coloumn do it with
// with the help of grid in css
// make responsive design for large screen 4 cards medium screen 3 cards
// mid-small screen 2 card and small screen 1 cards
...
User_data.forEach((el) => {
  ...
  profilePicture.src = el.image;

  let name = document.createElement("div");
  name.className = "name";
  name.innerText = el.firstName + " " + el.lastName; //+ " " + el.maidenName;
  ...
  // legend.innerHTML = "user name";
  // username.append(legend);
  username.className = "username details";
  username.append("username: " + el.username);
  console.log(username);

  let age = document.createElement("div");
  age.className = "age details";
  age.innerText = "age: " + el.age;

  let password = document.createElement("div");
  password.className = "password details";
  password.innerText = "password: " + el.password;

  let gender = document.createElement("div");
  gender.className = "gender details";
  gender.innerText = "gender: " + el.gender;

  let birthDate = document.createElement("div");
  birthDate.className = "birthDate details";
  birthDate.innerText = "birth date: " + el.birthDate;

  let bloodGroup = document.createElement("div");
  bloodGroup.className = "bloodGroup details";
  bloodGroup.innerText = "blood group: " + el.bloodGroup;

  let height = document.createElement("div");
  height.className = "height details";
  height.innerText = "height: " + el.height;

  let weight = document.createElement("div");
  weight.className = "weight details";
  weight.innerText = "weight: " + el.weight;

  let eyeColor = document.createElement("div");
  eyeColor.className = "eyeColor details";
  eyeColor.innerText = "eye color: " + el.eyeColor;

  let hair = document.createElement("div");
  hair.className = "hair details";
  hair.innerText = "hair color: " + el.hair.color + " type " + el.hair.type;

  let domain = document.createElement("div");
  domain.className = "domain details";
  domain.innerText = "domain: " + el.domain;

  let ip = document.createElement("div");
  ip.className = "ip details";
  ip.innerText = "ip: " + el.ip;
